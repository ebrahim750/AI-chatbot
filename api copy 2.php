...
// 2. Gemini API configuration (without key in URL)
...
STRICT RULE:  
- If the user asks any question that is NOT covered by the COMPANY INFORMATION above, politely explain that you cannot answer and state that you happy to help answer questions about the company and any info to help them book.
